...
/*   Updated: 2015/05/03 19:28:52 by frcugy           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (c == '5')
		print_brick_5(y, x, f, e);
	if (c == '1')
		print_brick_1(y, x, f, e);
	if (c == '4')
		print_brick_4(y, x, f, e);
	if (c == '2')
		print_brick_2(y, x, f, e);
	if (c == '3')
		print_brick_3(y, x, f, e);
}
